export const SITE_NAME = 'Toolbelt'
export const SITE_ORIGIN = 'https://sourabh.site'
...
export const SEO = {
  '/': {
    title: 'Toolbelt — Free Developer Tools That Run In Your Browser',
    description:
    ...
    blurb:
      'Toolbelt is a collection of 11 everyday developer tools that run entirely in your browser. Nothing you paste is uploaded to a server, so you can safely work with production payloads, tokens and customer data.',
  },
  '/json-xml': {
    title: 'JSON & XML Formatter, Validator and Search — Toolbelt',
    description:
  ...
  '/convert': {
    title: 'JSON to YAML to CSV Converter — Free & Online — Toolbelt',
    description:
  ...
  '/codegen': {
    title: 'JSON to TypeScript, Go, Java, Python & C# Model Generator — Toolbelt',
    description:
  ...
  '/sql': {
    title: 'SQL Formatter & Beautifier — 11 Dialects — Toolbelt',
    description:
  ...
  '/diff': {
    title: 'Text Diff Checker — Compare Two Files Online — Toolbelt',
    description:
  ...
  '/encode-decode': {
    title: 'Base64, URL Encoder / Decoder & Hash Generator (MD5, SHA) — Toolbelt',
    description:
  ...
  '/jwt-color': {
    title: 'JWT Decoder & HEX / RGB / HSL Color Converter — Toolbelt',
    description:
  ...
  '/timestamp': {
    title: 'Unix Timestamp Converter (IST, SAST, UTC), UUID & Regex Tester — Toolbelt',
    description:
  ...
  '/cron': {
    title: 'Cron Expression Builder & Parser — Next Run Times — Toolbelt',
    description:
  ...
  '/http': {
    title: 'HTTP Status Codes, Methods & Headers Reference — Toolbelt',
    description:
  ...
  '/mock': {
    title: 'Mock Data Generator — JSON, CSV & SQL Inserts — Toolbelt',
    description:
  ...
  '/about': {
    title: 'About Toolbelt — Built by Sourabh Kumar',
    description:
      'Toolbelt is a local-first developer toolbox built by Sourabh Kumar, a backend developer. No trackers, no ads, no sign-up, and nothing you paste ever leaves your browser.',
    heading: 'About Toolbelt',
    blurb:
      'Toolbelt was built to replace a pile of browser tabs pointed at ad-heavy formatter sites. Every tool runs as JavaScript in your own browser, so there is no server to send your data to in the first place.',
  },
}
